...
GETTEXT_FILES    = command.c commandbteq.c common.c copy.c crosstabview.c help.c input.c large_obj.c \
                   mainloop.c mainloopbteq.c psqlscanslash.c bteqscandot.c startup.c \
                   describe.c sql_help.h sql_help.c \
                   tab-complete.c variables.c \
                   ../../fe_utils/print.c ../../fe_utils/printbteq.c ../../fe_utils/psqlscan.c \
					../../fe_utils/bteqscan.c \
